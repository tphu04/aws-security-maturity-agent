...
from benchmark_llm_gen.planning_metrics import (
...
def run_inference(cases: List[Dict], rag_enabled: bool = True) -> List[Dict]:
    ...
    from config import OLLAMA_API_KEY, OLLAMA_BASE_URL, OLLAMA_MODEL, RAG_API_URL
...
def save_inference(outputs: List[Dict], run_dir: Path) -> Path:
    ...
    try:
        from config import OLLAMA_MODEL, RAG_API_URL
