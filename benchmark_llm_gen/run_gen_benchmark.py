...
Usage:
    ...
    python benchmark_llm_gen/run_gen_benchmark.py --mode inference-only

    # Chi evaluate tu inference da luu
    python benchmark_llm_gen/run_gen_benchmark.py --mode evaluate-only --inference-dir benchmark_llm_gen/inference_outputs/run_xxx
...
from benchmark_llm_gen.benchmark_generation import (
    INFERENCE_DIR,
    aggregate_results,
    load_cases,
    load_inference,
