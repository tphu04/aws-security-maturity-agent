...
Usage:
    ...
    python benchmark_llm_gen/run_report_benchmark.py --mode evaluate-only --inference-dir benchmark_llm_gen/inference_outputs/report_run_xxx

    # Custom test cases
    python benchmark_llm_gen/run_report_benchmark.py --mode full --cases custom_cases.json
...
from benchmark_llm_gen.benchmark_report import (
    INFERENCE_DIR,
    aggregate_results,
    load_cases,
    load_inference,
