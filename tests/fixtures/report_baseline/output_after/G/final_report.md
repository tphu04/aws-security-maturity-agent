...
<div class="cover-page">
    ...
    <p><strong>Mã báo cáo:</strong> RPT-20260420-E7B7</p>
...
<tbody>
    ...
    <tr><td><strong>Dịch vụ chính</strong></td>
        <td>AWS Infrastructure (nhiều dịch vụ)</td></tr>
...
<ul>
    <li><strong>Tổng số phát hiện:</strong> 9</li>
...
<ul>
    ...
    <li>Cao (High): <strong>3</strong></li>
    <li>Trung bình (Medium): <strong>3</strong></li>
...
<tr>
    <td>3</td>
    <td>Bucket logs-archive allows HTTP access</td>
    <td>s3</td>
...
<tr>
    <td>4</td>
    <td>IAM user alice does not have MFA enabled</td>
    <td>iam</td>
    <td><small>arn:aws:iam::123456789012:user/alice</small></td>
    <td><span class="sev-high">High</span></td>
    <td>FAIL</td>
    <td>PASS</td>
    <td class="status-fixed">
...
<tr>
    <td>5</td>
    <td>IAM role admin has inline policy attached</td>
    <td>iam</td>
    <td><small>arn:aws:iam::123456789012:role/admin</small></td>
    <td><span class="sev-medium">Medium</span></td>
    <td>FAIL</td>
    <td>FAIL</td>
    <td class="status-error">
...
<tr>
    <td>7</td>
    <td>EC2 instance i-0abc1 still allows IMDSv1</td>
    <td>ec2</td>
    <td><small>i-0abc1</small></td>
    <td><span class="sev-high">High</span></td>
    <td>FAIL</td>
    <td>PASS</td>
    <td class="status-fixed">
...
<tr>
    <td>8</td>
    <td>EC2 instance i-0abc2 has a public IP</td>
    <td>ec2</td>
    <td><small>i-0abc2</small></td>
    <td><span class="sev-medium">Medium</span></td>
    <td>FAIL</td>
    <td>FAIL</td>
...
<p style="text-align:center; font-size:0.8em; color:#999;">
    Mã báo cáo: RPT-20260420-E7B7 | Ngày tạo: 2026-04-20 |
    PDCA Security Agent
</p>
