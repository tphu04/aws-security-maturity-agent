...
<div class="cover-page">
    ...
    <p><strong>Mã báo cáo:</strong> RPT-20260420-BCAB</p>
...
Đánh giá bảo mật đã được thực hiện trên tài khoản 123456789012 vùng us-east-1. Tổng cộng 0 kiểm tra cấu hình trong phạm vi S3. Toàn bộ 0 kiểm tra đều đạt chuẩn (PASS). Không phát hiện lỗi bảo mật nào cần khắc phục.
...
Toàn bộ các kiểm tra cấu hình đều đạt chuẩn. Không ghi nhận lỗi bảo mật trong phạm vi đánh giá.
...
<div style="text-align:center; margin: 20px 0;">
    <div class="metric-card">
        <div class="metric-value" style="color:#2E7D32">0.0%</div>
    ...
    <div class="metric-card">
        <div class="metric-value" style="color:#1565C0">0.0%</div>
...
<tr>
    ...
    <td>0</td>
    <td>0</td>
    <td class="delta-positive">+0</td>
</tr>
<tr>
    <td>Findings FAIL</td>
    <td>0</td>
    <td>0</td>
    <td class="delta-zero">0</td>
</tr>
<tr>
    <td>Pass Rate</td>
    <td>0.0%</td>
...
<div class="metric-card" style="display:block; text-align:left; padding:15px 20px; margin:15px 0; background:#f8f9fa; border-left:4px solid #1565C0;">
    ...
    <table style="width:100%; margin-top:8px; font-size:0.95em;">
        ...
        <tr>
            ...
            <td style="padding:4px 12px; font-weight:bold;" colspan="3">0</td>
        </tr>
    </table>
</div>


Hệ thống hiện tại đạt chuẩn bảo mật. Khuyến nghị tiếp tục giám sát định kỳ và cập nhật cấu hình theo các tiêu chuẩn mới nhất.
...
<p style="text-align:center; font-size:0.8em; color:#999;">
    Mã báo cáo: RPT-20260420-BCAB | Ngày tạo: 2026-04-20 |
    PDCA Security Agent
</p>
