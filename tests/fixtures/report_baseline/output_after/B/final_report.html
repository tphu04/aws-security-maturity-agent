...
<div class="cover-page">
    ...
    <p><strong>Mã báo cáo:</strong> RPT-20260420-5F81</p>

    <div class="score-box">
        <span class="score-number">49</span>
        <span>/ 100</span>
...
<ul>
    ...
    <li><strong>ĐẠT (PASS):</strong> 0</li>
    <li><strong>KHÔNG ĐẠT (FAIL):</strong> 6</li>
</ul>
<p><strong>Phân bổ mức độ nghiêm trọng:</strong></p>
<ul>
    <li>Nghiêm trọng (Critical): <strong>2</strong></li>
    <li>Cao (High): <strong>2</strong></li>
    <li>Trung bình (Medium): <strong>1</strong></li>
...
Không ghi nhận cấu hình nào đạt chuẩn (PASS) trong phạm vi đánh giá này. Toàn bộ kiểm tra đều cho kết quả FAIL.
...
<tr>
    <td>1</td>
    <td>Bucket prod-data-lake has public ACL grants</td>
    <td>s3</td>
...
<tr>
    <td>2</td>
    <td>Bucket logs-archive missing default encryption</td>
    <td>s3</td>
...
<tr>
    <td>3</td>
    <td>Bucket backup-prod has versioning disabled</td>
    <td>s3</td>
    <td><small>backup-prod</small></td>
    <td><span class="sev-high">High</span></td>
    <td>FAIL</td>
    <td>PASS</td>
    <td class="status-fixed">
...
<tr>
    <td>4</td>
    <td>Bucket public-assets allows plain HTTP access</td>
    <td>s3</td>
...
<tr>
    <td>5</td>
    <td>Bucket analytics-warehouse policy allows public write</td>
    <td>s3</td>
    <td><small>analytics-warehouse</small></td>
    <td><span class="sev-critical">Critical</span></td>
    <td>FAIL</td>
    <td>FAIL</td>
...
<tr>
    <td>6</td>
    <td>Bucket ops-backup has server access logging disabled</td>
    <td>s3</td>
...
<div style="text-align:center; margin: 20px 0;">
    ...
    <div class="metric-card">
        <div class="metric-value" style="color:#1565C0">60.0%</div>
...
<p>Tổng cộng <strong>3</strong> findings vẫn còn FAIL sau khắc phục:</p>
<table class="styled-table">
...
<div class="metric-card" style="display:block; text-align:left; padding:15px 20px; margin:15px 0; background:#f8f9fa; border-left:4px solid #1565C0;">
    ...
    <table style="width:100%; margin-top:8px; font-size:0.95em;">
        <tr>
            ...
            <td style="padding:4px 12px; font-weight:bold;">6</td>
            <td style="padding:4px 12px;">Fix tự động thành công</td>
            <td style="padding:4px 12px; color:#2E7D32; font-weight:bold;">3</td>
        </tr>
        <tr>
            <td style="padding:4px 12px;">Fix tự động thất bại</td>
            <td style="padding:4px 12px; color:#C62828; font-weight:bold;">2</td>
        ...
        <tr>
            ...
            <td style="padding:4px 12px; font-weight:bold;" colspan="3">3</td>
        </tr>
    </table>
</div>
...
<p style="text-align:center; font-size:0.8em; color:#999;">
    Mã báo cáo: RPT-20260420-5F81 | Ngày tạo: 2026-04-20 |
    PDCA Security Agent
</p>
