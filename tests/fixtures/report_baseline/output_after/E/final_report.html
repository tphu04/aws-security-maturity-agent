...
<div class="cover-page">
    ...
    <p><strong>Mã báo cáo:</strong> RPT-20260420-176A</p>
...
<ul>
    <li><strong>Tổng số phát hiện:</strong> 12</li>
    <li><strong>ĐẠT (PASS):</strong> 4</li>
    <li><strong>KHÔNG ĐẠT (FAIL):</strong> 8</li>
</ul>
<p><strong>Phân bổ mức độ nghiêm trọng:</strong></p>
<ul>
    <li>Nghiêm trọng (Critical): <strong>0</strong></li>
    <li>Cao (High): <strong>4</strong></li>
    <li>Trung bình (Medium): <strong>4</strong></li>
    <li>Thấp (Low): <strong>0</strong></li>
</ul>
...
<p><em>Ghi chú: 4 findings không thay đổi trạng thái (PASS &rarr; PASS) đã được ẩn.
...
<tr>
    <td>1</td>
    <td>s3_bucket_default_encryption for bucket prod-data-lake</td>
    <td>s3</td>
...
<tr>
    <td>2</td>
    <td>s3_bucket_object_versioning for bucket prod-data-lake</td>
    <td>s3</td>
    <td><small>prod-data-lake</small></td>
...
<tr>
    <td>4</td>
    <td>s3_bucket_default_encryption for bucket logs-archive</td>
    <td>s3</td>
...
<tr>
    <td>5</td>
    <td>s3_bucket_object_versioning for bucket logs-archive</td>
    <td>s3</td>
    <td><small>logs-archive</small></td>
    <td><span class="sev-medium">Medium</span></td>
    <td>FAIL</td>
...
<tr>
    <td>7</td>
    <td>s3_bucket_default_encryption for bucket public-assets</td>
    <td>s3</td>
...
<tr>
    <td>8</td>
    <td>s3_bucket_object_versioning for bucket public-assets</td>
    <td>s3</td>
    <td><small>public-assets</small></td>
    <td><span class="sev-medium">Medium</span></td>
    <td>FAIL</td>
...
<tr>
    <td>10</td>
    <td>s3_bucket_default_encryption for bucket ops-backup</td>
    <td>s3</td>
    <td><small>ops-backup</small></td>
    <td><span class="sev-high">High</span></td>
    <td>FAIL</td>
    <td>PASS</td>
    <td class="status-fixed">
...
<tr>
    <td>11</td>
    <td>s3_bucket_object_versioning for bucket ops-backup</td>
    <td>s3</td>
    <td><small>ops-backup</small></td>
    <td><span class="sev-medium">Medium</span></td>
    <td>FAIL</td>
...
<p><em>4 findings không thay đổi trạng thái đã được ẩn.</em></p>
...
<div style="text-align:center; margin: 20px 0;">
    <div class="metric-card">
        <div class="metric-value" style="color:#2E7D32">50.0%</div>
    ...
    <div class="metric-card">
        <div class="metric-value" style="color:#1565C0">50.0%</div>
...
<p>Tổng cộng <strong>4</strong> findings vẫn còn FAIL sau khắc phục:</p>
<table class="styled-table">
...
<div class="metric-card" style="display:block; text-align:left; padding:15px 20px; margin:15px 0; background:#f8f9fa; border-left:4px solid #1565C0;">
    ...
    <table style="width:100%; margin-top:8px; font-size:0.95em;">
        <tr>
            ...
            <td style="padding:4px 12px; font-weight:bold;">8</td>
            <td style="padding:4px 12px;">Fix tự động thành công</td>
            <td style="padding:4px 12px; color:#2E7D32; font-weight:bold;">4</td>
        </tr>
        <tr>
            <td style="padding:4px 12px;">Fix tự động thất bại</td>
            <td style="padding:4px 12px; color:#C62828; font-weight:bold;">4</td>
            <td style="padding:4px 12px;">Cần xử lý thủ công</td>
            <td style="padding:4px 12px; color:#E65100; font-weight:bold;">0</td>
        </tr>
        <tr>
            <td style="padding:4px 12px;">FAIL còn lại sau khắc phục</td>
            <td style="padding:4px 12px; font-weight:bold;" colspan="3">4</td>
        </tr>
    </table>
</div>
...
<p style="text-align:center; font-size:0.8em; color:#999;">
    Mã báo cáo: RPT-20260420-176A | Ngày tạo: 2026-04-20 |
    PDCA Security Agent
</p>
