...
<div class="cover-page">
    ...
    <p><strong>Mã báo cáo:</strong> RPT-20260420-A39E</p>
...
<ul>
    ...
    <li><strong>ĐẠT (PASS):</strong> 2</li>
    <li><strong>KHÔNG ĐẠT (FAIL):</strong> 4</li>
</ul>
...
<p><em>Ghi chú: 2 findings không thay đổi trạng thái (PASS &rarr; PASS) đã được ẩn.
...
<tr>
    <td>2</td>
    <td>IAM user bob does not have MFA enabled</td>
    <td>iam</td>
    <td><small>arn:aws:iam::123456789012:user/bob</small></td>
    <td><span class="sev-high">High</span></td>
    <td>FAIL</td>
    <td>PASS</td>
    <td class="status-fixed">
...
<tr>
    <td>4</td>
    <td>Root account MFA is disabled</td>
    <td>iam</td>
    <td><small>123456789012</small></td>
...
<tr>
    <td>5</td>
    <td>Password policy does not meet strength requirements</td>
    <td>iam</td>
    <td><small>123456789012</small></td>
...
<p><em>2 findings không thay đổi trạng thái đã được ẩn.</em></p>
...
<div style="text-align:center; margin: 20px 0;">
    <div class="metric-card">
        <div class="metric-value" style="color:#2E7D32">75.0%</div>
...
<div class="metric-card" style="display:block; text-align:left; padding:15px 20px; margin:15px 0; background:#f8f9fa; border-left:4px solid #1565C0;">
    ...
    <table style="width:100%; margin-top:8px; font-size:0.95em;">
        <tr>
            ...
            <td style="padding:4px 12px; font-weight:bold;">4</td>
...
<p style="text-align:center; font-size:0.8em; color:#999;">
    Mã báo cáo: RPT-20260420-A39E | Ngày tạo: 2026-04-20 |
    PDCA Security Agent
</p>
