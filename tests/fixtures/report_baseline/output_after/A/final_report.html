...
<div class="cover-page">
    ...
    <p><strong>Mã báo cáo:</strong> RPT-20260420-5B5E</p>
...
Đánh giá bảo mật đã được thực hiện trên tài khoản 123456789012 vùng us-east-1. Tổng cộng 6 kiểm tra cấu hình trong phạm vi S3. Toàn bộ 6 kiểm tra đều đạt chuẩn (PASS). Không phát hiện lỗi bảo mật nào cần khắc phục.
...
<ul>
    ...
    <li><strong>ĐẠT (PASS):</strong> 6</li>
...
<p><em>Ghi chú: 6 findings không thay đổi trạng thái (PASS &rarr; PASS) đã được ẩn.
...
<p><em>6 findings không thay đổi trạng thái đã được ẩn.</em></p>
...
<p style="text-align:center; font-size:0.8em; color:#999;">
    Mã báo cáo: RPT-20260420-5B5E | Ngày tạo: 2026-04-20 |
    PDCA Security Agent
</p>
