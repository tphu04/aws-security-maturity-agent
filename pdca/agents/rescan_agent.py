...
class RescanAgent:
    ...
    def __init__(self, config_path="data/artifacts/initial_scan_config.json", scanner_base_url: str = None):
        self.config_path = config_path
        if scanner_base_url is None:
            from pdca.config import SCANNER_API_URL
    ...
    def run(self):
        ...
        print("-" * 40)
        print(f"[RescanAgent] 💾 Dữ liệu đã lưu vào 'data/artifacts/post_scan.json'")
